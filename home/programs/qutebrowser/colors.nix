# Politely stolen from https://github.com/LilleAila/dotfiles/blob/746aacada7f10bc6edd66ac20a408160db181b7e/home/modules/desktop/programs/qutebrowser/colors.nix
{config, ...}: let
